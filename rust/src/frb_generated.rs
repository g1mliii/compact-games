...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1963370196;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        31 => wire__crate__api__discovery__remove_game_from_discovery_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        35 => wire__crate__api__automation__shared_auto_state_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        36 => wire__crate__api__automation__start_auto_compression_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        38 => wire__crate__api__unsupported__sync_unsupported_report_collection_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        40 => wire__crate__api__automation__update_automation_config_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        42 => wire__crate__api__automation__watch_auto_compression_status_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        43 => wire__crate__api__automation__watch_automation_queue_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        44 => wire__crate__api__automation__watch_scheduler_state_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        45 => wire__crate__api__automation__watch_watcher_events_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        28 => wire__crate__api__discovery__normalize_game_name_impl(ptr, rust_vec_len, data_len),
        29 => wire__crate__api__compression__persist_compression_history_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        37 => wire__crate__api__automation__stop_auto_compression_impl(ptr, rust_vec_len, data_len),
        39 => wire__crate__api__unsupported__unreport_unsupported_game_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        41 => wire__crate__api__update__update_check_interval_ms_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
